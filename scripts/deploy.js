...
async function main() {
  ...
  const NFTWorldsPlayersV1_1Factory = await ethers.getContractFactory('NFT_Worlds_Players_V1_1', polygonWallet);

  // Deploy Polygon
  const polygonPlayersContract = await NFTWorldsPlayersV1_1Factory.deploy(
    FORWARDER_ADDRESS,
    IPFS_GATEWAY,
  );
